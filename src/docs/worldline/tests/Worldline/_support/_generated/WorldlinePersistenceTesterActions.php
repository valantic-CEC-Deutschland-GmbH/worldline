<?php  //[STAMP] 5f58365289e727e564a4b1f8be2e3a0b
// phpcs:ignoreFile
namespace ValanticSprykerTest\Zed\Worldline\_generated;

// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build

trait WorldlinePersistenceTesterActions
{
    /**
     ...
     */
    public function haveOrder(array $override = [], ?string $stateMachineProcessName = NULL, array $saveOrderStack = []): \Generated\Shared\Transfer\SaveOrderTransfer {
     ...
     */
    public function haveOrderFromQuote(\Generated\Shared\Transfer\QuoteTransfer $quoteTransfer, ?string $stateMachineProcessName = NULL, array $checkoutDoSaveOrderPlugins = []): \Generated\Shared\Transfer\SaveOrderTransfer {
     ...
     */
    public function haveOrderUsingPreparedQuoteTransfer(\Generated\Shared\Transfer\QuoteTransfer $quoteTransfer, ?string $stateMachineProcessName = NULL, array $saveOrderStack = []): \Generated\Shared\Transfer\SaveOrderTransfer {
     ...
     *
     * @return void
     * @see \SprykerTest\Shared\Sales\Helper\SalesDataHelper::cleanStaticProperty()
     */
    ...
    public function createOrderWithOneItem(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('createOrderWithOneItem', func_get_args()));
    }
     ...
     */
    public function createSalesOrderItemForOrder(int $idSalesOrder, array $salesOrderItem = []): \Orm\Zed\Sales\Persistence\SpySalesOrderItem {
    ...
    public function createDiscountForSalesOrderItem(int $idSalesOrderItem, array $discount = []): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('createDiscountForSalesOrderItem', func_get_args()));
    }
     ...
     * @see \SprykerTest\Zed\Oms\Helper\OmsHelper::haveOmsProductReservation()
     */
    public function haveOmsProductReservation(array $seed): \Generated\Shared\Transfer\OmsProductReservationTransfer {
     ...
     * @see \SprykerTest\Zed\Oms\Helper\OmsHelper::haveOmsOrderItemStateEntity()
     */
    public function haveOmsOrderItemStateEntity(string $name): \Orm\Zed\Oms\Persistence\SpyOmsOrderItemState {
     ...
     * @see \SprykerTest\Zed\Oms\Helper\OmsHelper::getOmsEventTriggerResponseTransfer()
     */
    public function getOmsEventTriggerResponseTransfer(array $seedData): \Generated\Shared\Transfer\OmsEventTriggerResponseTransfer {
     ...
     * @see \SprykerTest\Zed\Oms\Helper\OmsHelper::haveOmsEventTimeoutEntity()
     */
    public function haveOmsEventTimeoutEntity(array $seed): \Orm\Zed\Oms\Persistence\SpyOmsEventTimeout {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveOmsEventTimeoutEntity', func_get_args()));
    }
     ...
     * @see \SprykerTest\Client\Queue\Helper\QueueHelper::getQueueClient()
     */
    public function getQueueClient(): \Spryker\Client\Queue\QueueClientInterface {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getQueueClient', func_get_args()));
    }
     ...
     * @see \SprykerTest\Shared\Quote\Helper\PersistentQuoteHelper::havePersistentQuote()
     */
    public function havePersistentQuote(array $seed = []): \Generated\Shared\Transfer\QuoteTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('havePersistentQuote', func_get_args()));
    }
     ...
     */
    public function haveProduct(array $productConcreteOverride = [], array $productAbstractOverride = []): \Generated\Shared\Transfer\ProductConcreteTransfer {
     ...
     */
    public function haveProductAbstract(array $productAbstractOverride = []): \Generated\Shared\Transfer\ProductAbstractTransfer {
     ...
     * @see \SprykerTest\Zed\Sales\Helper\BusinessHelper::create()
     */
    public function create(): \Orm\Zed\Sales\Persistence\SpySalesOrder {
     ...
     *
     * @return \Orm\Zed\Sales\Persistence\SpySalesOrder
     * @see \SprykerTest\Zed\Sales\Helper\BusinessHelper::haveSalesOrderEntity()
     */
    public function haveSalesOrderEntity(iterable $itemTransfers = [], array $salesOrderOverride = []): \Orm\Zed\Sales\Persistence\SpySalesOrder {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveSalesOrderEntity', func_get_args()));
    }
     ...
     * @see \ValanticSprykerTest\Shared\Worldline\Helper\HostedCheckoutHelper::haveHostedCheckout()
     */
    public function haveHostedCheckout(\Generated\Shared\Transfer\SaveOrderTransfer $saveOrderTransfer, \Generated\Shared\Transfer\QuoteTransfer $quoteTransfer, array $paymentWorldlineOverride = [], array $paymentWorldlineHostedCheckoutOverride = ["fkWorldlineApiLog" => NULL, "fkWorldlineRestLog" => NULL], array $paymentWorldlineTransactionStatusLogOverride = []): \Generated\Shared\Transfer\PaymentWorldlineTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveHostedCheckout', func_get_args()));
    }
     ...
     *
     *
     * @see \ValanticSprykerTest\Shared\Worldline\Helper\PaymentTokenHelper::havePaymentTokenWithThreeDSecureDataForCustomer()
     */
     ...
     *
     *
     * @see \ValanticSprykerTest\Shared\Customer\Helper\CustomerAddressDataHelper::haveCustomerAddress()
     */
     ...
     * @see \SprykerTest\Shared\Shipment\Helper\ShipmentCarrierDataHelper::haveShipmentCarrier()
     */
    public function haveShipmentCarrier(array $override = []): \Generated\Shared\Transfer\ShipmentCarrierTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveShipmentCarrier', func_get_args()));
    }
     ...
     * @see \SprykerTest\Shared\Shipment\Helper\ShipmentDataHelper::haveShipment()
     */
    public function haveShipment(int $idSalesOrder, array $overrideShipment = []): \Generated\Shared\Transfer\ShipmentTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveShipment', func_get_args()));
    }
     ...
     * @see \SprykerTest\Shared\Shipment\Helper\ShipmentMethodDataHelper::haveShipmentMethod()
     */
    public function haveShipmentMethod(array $overrideShipmentMethod = [], array $overrideCarrier = [], array $priceList = \SprykerTest\Shared\Shipment\Helper\ShipmentMethodDataHelper::DEFAULT_PRICE_LIST, array $idStoreList = []): \Generated\Shared\Transfer\ShipmentMethodTransfer {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveShipmentMethod', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \SprykerTest\Shared\Shipment\Helper\ShipmentMethodDataHelper::ensureShipmentMethodTableIsEmpty()
     */
    public function ensureShipmentMethodTableIsEmpty(): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('ensureShipmentMethodTableIsEmpty', func_get_args()));
    }
}
