 ...
 */
class GetHostedCheckoutStatusCommandPlugin extends AbstractCommandPlugin implements CommandByOrderInterface
{
    /**
    ...
    {
        $this->getFacade()->handleGetHostedCheckoutStatusCommand($orderItems, $this->getOrderTransfer($orderEntity));
