...
namespace ValanticSpryker\Zed\Worldline\Communication\Plugin\Oms\Condition;
 ...
 */
class WorldlineIsHostedCheckoutStatusCancelledConditionPlugin extends AbstractCondition
{
    /**
    ...
    {
        return $this->getFacade()->isHostedCheckoutStatusCancelled($orderItem);
    }
}
