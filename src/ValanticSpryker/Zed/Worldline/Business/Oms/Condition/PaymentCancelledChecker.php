...
class PaymentCancelledChecker implements PaymentCancelledCheckerInterface
{
    /**
    ...
    public function isPaymentCancelled(SpySalesOrderItem $orderItem): bool
    {
        ...
        return $transactionStatusTransfer->getStatus() === WorldlineConstants::STATUS_CANCELLED;
    }
}
